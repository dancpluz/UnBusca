...
public class Tela {    
    ...
    public static void abrirTela(FXMLLoader f) throws IOException {                    
        Parent root = f.load();   
    ...
    public static void abrirTela(String local) throws IOException {
        abrirTela(telaFxmlLoader(local));
    }
